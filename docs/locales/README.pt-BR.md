...
Versão atual do código-fonte e da publicação no GitHub: `2.8.22`
...
- **Gerenciamento de propriedades:** visualize sugestões antes de aplicá-las em lote e mantenha campos desconhecidos intactos.
...
Depois da aprovação no diretório da comunidade, procure KnowGrove em **Configurações → Plugins da comunidade → Explorar**.
