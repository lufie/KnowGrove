...
`2.8.26` 是当前公开 GitHub 正式版；`2.8.28` 是本轮待公开发布的新候选。`2.8.28` 使用独立版本承接未公开的 `2.8.27` 候选及之后已合入私有主线的采集占位文档、图片转文本、超长文档导航和实时预览表格修复，不覆盖旧候选资产。只有公开白名单导出、精确标签和非草稿 GitHub Release、三资产摘要回读、公开地址 clean Vault 首次安装、当前 Vault 升级回读与社区后台接收全部完成后，才能更新为已发布；商店缓存刷新单独记录。
